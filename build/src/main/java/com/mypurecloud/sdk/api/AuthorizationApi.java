...
public interface AuthorizationApi {
  ...
  Call<PermissionCollectionEntityListing> getPermissions(
  ...
  Call<OrganizationProductEntityListing> getProducts();
  ...
  Call<OrganizationRoleEntityListing> getRoles(
    @Query("pageSize") Integer pageSize, @Query("pageNumber") Integer pageNumber, @Query("sortBy") String sortBy, @Query("expand") List<Object> expand, @Query("nextPage") String nextPage, @Query("previousPage") String previousPage, @Query("permission") List<Object> permission, @Query("userCount") Boolean userCount
  );
  ...
  Call<DomainOrgRoleDifference> getRolesLeftroleIdComparedefaultRightroleId(
  ...
  Call<DomainOrganizationRole> getRolesRoleId(
    @Path("roleId") String roleId
  );
  ...
  Call<DomainOrganizationRole> patchRolesRoleId(
  ...
  Call<DomainOrganizationRole> postRoles(
  ...
  Call<OrganizationRoleEntityListing> postRolesDefault(
  ...
  Call<DomainOrgRoleDifference> postRolesLeftroleIdComparedefaultRightroleId(
  ...
  Call<OrganizationRoleEntityListing> putRolesDefault(
  ...
  Call<DomainOrganizationRole> putRolesRoleId(
    @Path("roleId") String roleId, @Body DomainOrganizationRole body
  );
  ...
  Call<List<String>> putRolesRoleIdUsersAdd(
  ...
  Call<List<String>> putRolesRoleIdUsersRemove(
    @Path("roleId") String roleId, @Body List<String> body
  );
