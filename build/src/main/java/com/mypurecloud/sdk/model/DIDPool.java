...
public class DIDPool  implements Serializable {
   ...
   **/
  @ApiModelProperty(required = true, value = "The starting phone number for the range of this DID pool. Must be in E.164 format")
   ...
   **/
  @ApiModelProperty(required = true, value = "The ending phone number for the range of this DID pool. Must be in E.164 format")
