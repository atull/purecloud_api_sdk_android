...
public class EdgeGroup   {
  ...
  private List<UriReference> phoneTrunkBases = new ArrayList<UriReference>();
   ...
   **/
  @ApiModelProperty(value = "Trunk base settings assignments of trunkType \"PHONE\" to inherit to edge logical interfaces for phone communication.")
  ...
  public List<UriReference> getPhoneTrunkBases() {
    return phoneTrunkBases;
  }
  public void setPhoneTrunkBases(List<UriReference> phoneTrunkBases) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, edgeGroup.id) &&
        ...
        Objects.equals(phoneTrunkBaseAssignments, edgeGroup.phoneTrunkBaseAssignments) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, version, dateCreated, dateModified, modifiedBy, createdBy, state, modifiedByApp, createdByApp, managed, edgeTrunkBaseAssignment, phoneTrunkBaseAssignments, phoneTrunkBases, selfUri);
  }
