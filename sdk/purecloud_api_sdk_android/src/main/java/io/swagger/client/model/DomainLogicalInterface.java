...
import io.swagger.client.model.DomainCapabilities;
import io.swagger.client.model.DomainNetworkAddress;
import io.swagger.client.model.DomainNetworkCommandResponse;
import io.swagger.client.model.DomainNetworkRoute;
import io.swagger.client.model.TrunkBaseAssignment;
...
public class DomainLogicalInterface   {
  ...
  @SerializedName("inheritPhoneTrunkBases")
  private Boolean inheritPhoneTrunkBases = false;
   ...
   **/
  @ApiModelProperty(value = "Phone trunk base assignment will be inherited from the Edge Group.")
  public Boolean getInheritPhoneTrunkBases() {
    return inheritPhoneTrunkBases;
  }
  public void setInheritPhoneTrunkBases(Boolean inheritPhoneTrunkBases) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, domainLogicalInterface.id) &&
        ...
        Objects.equals(inheritPhoneTrunkBases, domainLogicalInterface.inheritPhoneTrunkBases) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, version, dateCreated, dateModified, modifiedBy, createdBy, state, modifiedByApp, createdByApp, edgeUri, edgeAssignedId, friendlyName, vlanTagId, hardwareAddress, physicalAdapterId, ipAddress, gateway, primaryDns, secondaryDns, ifStatus, routes, addresses, ipv4Capabilities, ipv6Capabilities, currentState, lastModifiedUserId, lastModifiedCorrelationId, commandResponses, inheritPhoneTrunkBases, inheritPhoneTrunkBasesIPv4, inheritPhoneTrunkBasesIPv6, useForInternalEdgeCommunication, externalTrunkBaseAssignments, phoneTrunkBaseAssignments, selfUri);
  }
  ...
  public String toString() {
    ...
    sb.append("    inheritPhoneTrunkBases: ").append(toIndentedString(inheritPhoneTrunkBases)).append("\n");
