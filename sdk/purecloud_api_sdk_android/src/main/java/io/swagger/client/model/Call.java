...
import io.swagger.client.model.DisconnectReason;
...
public class Call   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(state, id, direction, recording, recordingState, muted, confined, held, recordingId, segments, errorInfo, disconnectType, startHoldTime, documentId, connectedTime, disconnectedTime, disconnectReasons);
  }
