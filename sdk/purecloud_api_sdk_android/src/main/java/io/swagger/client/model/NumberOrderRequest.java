...
public class NumberOrderRequest   {
  ...
  @SerializedName("orderTns")
  private List<String> orderTns = new ArrayList<String>();

  @SerializedName("reservationIds")
  private List<String> reservationIds = new ArrayList<String>();
  ...
  public List<String> getOrderTns() {
    return orderTns;
  }
  public void setOrderTns(List<String> orderTns) {
   ...
   * The type of phone number (eg us-domestic, toll-free, etc), to determine which third-party api(s) to use for the order request.
   **/
  @ApiModelProperty(value = "The type of phone number (eg us-domestic, toll-free, etc), to determine which third-party api(s) to use for the order request.")
  ...
  public boolean equals(Object o) {
    ...
    NumberOrderRequest numberOrderRequest = (NumberOrderRequest) o;
    return Objects.equals(orderTns, numberOrderRequest.orderTns) &&
        Objects.equals(reservationIds, numberOrderRequest.reservationIds) &&
        Objects.equals(orderId, numberOrderRequest.orderId) &&
        Objects.equals(effectiveDate, numberOrderRequest.effectiveDate) &&
        Objects.equals(phoneNumberType, numberOrderRequest.phoneNumberType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderTns, reservationIds, orderId, effectiveDate, phoneNumberType);
  }
  ...
  public String toString() {
    ...
    sb.append("    orderTns: ").append(toIndentedString(orderTns)).append("\n");
