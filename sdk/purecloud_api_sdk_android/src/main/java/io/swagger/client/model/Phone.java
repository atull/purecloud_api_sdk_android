...
import io.swagger.client.model.PhoneStatus;
...
public class Phone   {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, phone.id) &&
        ...
        Objects.equals(edgeGroup, phone.edgeGroup) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, version, dateCreated, dateModified, modifiedBy, createdBy, state, modifiedByApp, createdByApp, edgeGroup, site, phoneBaseSettings, lineBaseSettings, phoneMetaBase, lines, status, secondaryStatus, properties, capabilities, webRtcUser, selfUri);
  }
